...
class MemberCharts
{
    ...
    public function build(): \ArielMejiaDev\LarapexCharts\BarChart
    {
        ...
        return $this->chart->barChart()
            ->setTitle('Grafik User Member Pelanggan')
            ->setSubtitle('Berikut grafik dari Member Pelanggan per tanggal')
            ->addData('Jumlah Member Pelanggan yang terdaftar di sistem', $data)
            ->setXAxis($date);
    }
}
