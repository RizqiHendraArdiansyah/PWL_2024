...
Route::group(['prefix' => 'welcome'], function () {
        Route::get('/', [WelcomeController::class, 'index']);          //menampilkan halaman awal user
        Route::post('/list', [WelcomeController::class, 'list']);      //menampilkan data user dalam bentuk json untuk datatables
        Route::get('/export-excel', [WelcomeController::class, 'exportExcel'])->name('member.export.excel'); //menampilkan export data ke excel
        Route::get('/create', [WelcomeController::class, 'create']);   //menampilkan halaman form tambah user
        Route::post('/', [WelcomeController::class, 'store']);         //menyimpan data user baru
        Route::get('/{id}', [WelcomeController::class, 'show']);       //menampilkan detail user
        Route::get('/{id}/edit', [WelcomeController::class, 'edit']);  //menampilkan halaman form edit user
        Route::put('/{id}', [WelcomeController::class, 'update']);     //menyimpan perubahan data user
